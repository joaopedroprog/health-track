...
<body>
        ...
        <table class="table">
            ...
            <tbody>
            	<c:forEach items="${pesos}" var="p">
	                <tr>
	                	<th scope="row">
	                		<fmt:formatDate value="${p.dataPeso.time}" pattern="dd/MM/yyyy"/>
	                	</th>
	                    ...
	                    <td><button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#excluirModal" onclick="codigoExcluir.value=${p.idPeso}">EXCLUIR</button></td>
	                </tr>
                </c:forEach>
            </tbody>
        </table>
    ...
    <br><br><br>
    <div class="add-ref">
        <a href="peso_add.jsp"><button type="button" class="btn btn-primary btn-lg">ADICIONAR PESO</button></a>
    </div>
