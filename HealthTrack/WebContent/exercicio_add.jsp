    ...
    <input type="hidden" value="cadastrar" name="acao">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="descricao-atv" name="descricao" rows="4"></textarea>
            </div>
            <div class="form-group">
                <label class="textlabel">Calorias gastas</label>
                <input id="calAtvInput" name="calorias" type="number" class="form-control" required>
            </div>
            <div class="form-group">
                <label class="textlabel" for="dataInput">Data do exercício</label>
                <input id="dataInput" name="data" type="date" class="form-control form-peq" required>
            </div>
            
            <div class="add-ref">
        		<input type="submit" class="btn btn-primary btn-lg" id="btn_exercicio" value="ADICIONAR EXERCÍCIO">
    		</div>
        </fieldset>
    </form>
</div>
