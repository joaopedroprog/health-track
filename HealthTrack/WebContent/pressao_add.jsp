...
<body>
    ...
    <div class="container-fluid padding"> 
        ...
        <input type="hidden" value="cadastrar" name="acao">
            <fieldset>
                <legend>Adicione o sua pressao</legend>
	 ...
	 <div class="form-group">
                ...
                <input id="sistInput" name="sistolica" type="number" min="0" max="200" class="form-control" required>
            </div>
            <div class="form-group">
                <label class="textlabel">Pressão Diastólica</label>
                <input id="diastInput" name="diastolica" type="number" min="0" max="100" class="form-control" required>
            </div>
            <div class="form-group">
            ...
            <div class="add-ref">
            		<input type="submit" class="btn btn-primary btn-lg" id ="btn_peso" value="ADICIONAR PRESSAO" >
        		</div>
            </fieldset>
        </form>
    </div>
