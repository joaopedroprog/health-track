...
<body>
    ...
    <div class="table-wrap topo">
        ...
        <table class="table">
            ...
            <tbody>
	            <c:forEach items="${exercicios}" var="p">
		                <tr>
		                	<th scope="row">
		                		<fmt:formatDate value="${p.dataExercicio.time}" pattern="dd/MM/yyyy"/>
		                	</th>
		                	
		                    <td>${p.tipoExercicio}</td>
		                    <td>${p.descricaoExercicio}</td>
		                    <td>${p.caloriasExercicio}</td>
		                    
		                    <td>
		                    	<c:url value="exercicio" var="link">
		                    		<c:param name="acao" value="abrir-form-edicao"/>
		                    		<c:param name="codigo" value="${p.idExercicio}"/>
		                    	</c:url>
		                    	<a class="icon-edit" href="${link}"><i class="far fa-edit"></i></a>
		                    </td>
		                    
		                    <td><button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#excluirModal" onclick="codigoExcluir.value=${p.idExercicio}">EXCLUIR</button></td>
		                </tr>
	                </c:forEach>
    ...
    <br><br><br>
    <div class="add-ref">
        <a href="exercicio_add.jsp"><button type="button" class="btn btn-primary btn-lg">ADICIONAR EXERCÍCIO</button></a>
    </div>
